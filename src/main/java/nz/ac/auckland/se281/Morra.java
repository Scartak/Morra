  ...
  public void play() {
    ...
    if (difficulty == Difficulty.EASY) {
      ...
      MessageCli.PRINT_INFO_HAND.printMessage(
          "Jarvis", String.valueOf(jarvisFinger), String.valueOf(jarvisSum));
    ...
    // Implements the master difficulty for top stratergy
      ...
      // if rounds is less than 3, jarvis would be easy otherwise the stratergy would
      // alternateberween medium and hard
      if (rounds <= 3) {
        strategy = new Random();
      } else if (rounds % 2 == 0) {
        strategy = StratergyFactory.getStratergy("Medium", player);
